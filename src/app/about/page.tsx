    ...
    <section>
      <div className={s.parent}>
        ...
        <div className={s.gridBox4}>
          ...
          <p className={s.text}>
            ми піднімаємо ваш світ за допомогою передової технології дронів DJI.
            Наша пристрасть до польотів і інновацій підноситься за горизонт,
            втілюючи захопливі перспективи, які колись були мрією авіаторів. Ми
            віримо в майбутнє мирне блакитне, як прапор небо, яке не є
            обмеженням, а стає майданчиком для творчості, дослідження та
            відкриття. Наша місія: забезпечити Вас остаточним досвідом оператора
            дрону. Незалежно від того, чи ви професійний військовий, фотограф,
            ентузіаст кіно, чи хобіст, який шукає нові висоти, наші дрони DJI -
            це ваші крила.
          </p>
        </div>
